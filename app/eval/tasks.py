...
BENCHMARK_TASKS = [
    ...
    # ====== 综合任务（20个，多阶段依赖，Master 最多拆 3 个） ======
    {"id": "T31", "category": "complex", "task": "分析这份CSV销售数据，生成3张图表，输出一份Markdown分析报告", "min_subtasks": 3},
    {"id": "T32", "category": "complex", "task": "搜索2026年AI趋势，整理成文档，再用Python生成趋势词云图", "min_subtasks": 3},
    {"id": "T33", "category": "complex", "task": "清洗数据→统计分析→画图→写报告→生成管理Dashboard网页", "min_subtasks": 3},
    {"id": "T34", "category": "complex", "task": "爬取新闻→情感分析→可视化→输出摘要报告", "min_subtasks": 3},
    {"id": "T35", "category": "complex", "task": "分析用户评价→分类统计→生成词云→写分析报告→生成HTML展示页", "min_subtasks": 3},
    {"id": "T36", "category": "complex", "task": "查天气数据→比较分析→画对比图→生成旅行建议文档", "min_subtasks": 3},
    {"id": "T37", "category": "complex", "task": "读入日志文件→解析错误→统计分析→生成运维报告", "min_subtasks": 3},
    {"id": "T38", "category": "complex", "task": "处理问卷数据→统计→画图→生成PPT式分析报告HTML", "min_subtasks": 3},
    {"id": "T39", "category": "complex", "task": "分析股票数据→技术指标计算→生成K线图→写投资建议摘要", "min_subtasks": 3},
    {"id": "T40", "category": "complex", "task": "人口数据分析→增长率计算→预测模型→可视化→生成政策建议报告", "min_subtasks": 3},
    {"id": "T41", "category": "complex", "task": "解析Excel财务报表→计算财务指标→画趋势图→生成财务分析报告", "min_subtasks": 3},
    {"id": "T42", "category": "complex", "task": "多源数据对比分析→差异检测→原因分析→生成对比报告HTML", "min_subtasks": 3},
    {"id": "T43", "category": "complex", "task": "用户行为数据分析→漏斗分析→热力图→优化建议文档", "min_subtasks": 3},
    {"id": "T44", "category": "complex", "task": "产品评论情感分析→好评差评归类→可视化对比→改进建议报告", "min_subtasks": 3},
    {"id": "T45", "category": "complex", "task": "电商数据分析→用户画像构建→RFM分层→营销策略文档", "min_subtasks": 3},
    {"id": "T46", "category": "complex", "task": "日志异常检测→异常模式分析→告警规则生成→运维监控看板HTML", "min_subtasks": 3},
    {"id": "T47", "category": "complex", "task": "竞品数据分析→市场份额计算→SWOT分析→战略建议报告", "min_subtasks": 3},
    {"id": "T48", "category": "complex", "task": "时间序列预测→ARIMA建模→预测结果可视化→业务决策建议", "min_subtasks": 3},
    {"id": "T49", "category": "complex", "task": "文本语料分析→关键词提取→主题建模→知识图谱可视化HTML", "min_subtasks": 3},
    {"id": "T50", "category": "complex", "task": "综合分析：数据清洗+统计+预测+可视化+报告+管理看板网页", "min_subtasks": 3},
]
